...
Issues live as GitHub issues; all operations use the `gh` CLI. See `docs/agents/issue-tracker.md`, including its note on **auto-closing issues from PR bodies** (one keyword per issue; verify the close set before merging).
